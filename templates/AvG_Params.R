...
MinimalInitialNumberOfTransitions_Filter=5 # Peptides with less than N transitions will be removed
...
TopN_RankedbyIntensity=6 # Number of most intense transitions in the spectral library (N) among which at least n transitions need to be present.
